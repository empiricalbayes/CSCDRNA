...
#' 500 rows (genes) and 5 columns (individuals). Slot \strong{sc.counts.matrix} contains
#' a sample single-cell data matrix with 500 rows (genes) and 20 columns (a combination of
